# Datpaq Printed CLI Agent Guide

This directory is a generated `datpaq` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
datpaq doctor --json
datpaq agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
datpaq which "<capability>" --json
datpaq <command> --help
```
