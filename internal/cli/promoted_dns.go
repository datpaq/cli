...
func newDnsPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmd.Flags().Changed("type") {
				allowedType := []string{"A", "AAAA", "MX", "CNAME", "TXT", "NS", "SOA", "ALL"}
				validType := false
	...
	cmd.Flags().StringVar(&flagType, "type", "A", "DNS record type. Defaults to A. (one of: A, AAAA, MX, CNAME, TXT, NS, SOA, ALL)")
