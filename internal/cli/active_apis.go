...
//
// "Active" affects DISCOVERY only — listings in `datpaq api`, `datpaq
// sample`, and the splash. Direct invocations like
// `datpaq aircraft lookup-by-tail` are unaffected; the underlying
// endpoint command stays registered and runnable regardless of activation.
