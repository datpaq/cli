...
func newMxLookupGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagTestSmtp != false {
				params["test_smtp"] = fmt.Sprintf("%v", flagTestSmtp)
			}
			if flagIncludeSpf != false {
				params["include_spf"] = fmt.Sprintf("%v", flagIncludeSpf)
			}
			data, prov, err := resolveRead(cmd.Context(), c, flags, "mx-lookup", false, path, params, nil)
			if err != nil {
