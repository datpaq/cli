...
func newGeneratePromotedCmd(flags *rootFlags) *cobra.Command {
	var bodyCount int
	...
	cmd.Flags().IntVar(&bodyCount, "count", 1, "Count")
	cmd.Flags().StringVar(&bodyFields, "fields", "", "Optional field names to include.")
	cmd.Flags().StringVar(&bodyFormat, "format", "json", "Format")
	cmd.Flags().StringVar(&bodyType, "type", "", "Schema type to generate, such as user, company, product, or transaction.")
